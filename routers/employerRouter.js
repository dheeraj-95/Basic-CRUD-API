...
employerRouter
    .post('/createEmployer', async (req,res) => {
        try{
    ...
    .post('/assignEmployee', async (req, res) => {
        try{
            const client = await MongoClient.connect(url,{ useUnifiedTopology: true });
            let db = client.db("employee-employer")
    ...
    .put('/updateEmployer', async (req, res) => {
        try{
            const client = await MongoClient.connect(url,{ useUnifiedTopology: true });
            let db = client.db("employee-employer")
            ...
            if(oldEmployerFind && newEmployerFind) {
                ...
                logger.debug('Employer Changed successfully');
    ...
    .get('/', async (req,res) => {
        try{
            ...
            logger.debug('Fetched employers from DB.');
